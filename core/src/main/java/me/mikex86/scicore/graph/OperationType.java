...
public enum OperationType {
    ...
    REDUCE_SUM(Category.RESHAPE, GENERIC), RESHAPE(Category.RESHAPE, GENERIC), TRANSPOSE(Category.RESHAPE, GENERIC), CONTIGUOUS(Category.RESHAPE, UNARY), FLATTEN(Category.RESHAPE, UNARY), // Reshape ops
