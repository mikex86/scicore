    ...
    if (aType == DATA_TYPE_FLOAT32 && bType == DATA_TYPE_FLOAT32 && cType == DATA_TYPE_FLOAT32) {
        ...
        tblas_blgemm(TblasRowMajor,
                     ...
                     *(int8_t *) alphaPtr, (int8_t *) aPtr, lda,
                     ...
                     (int64_t *) cPtr, ldc);
    } else if (aType == DATA_TYPE_INT8 && bType == DATA_TYPE_FLOAT32) {
        tblas_bfgemm(TblasRowMajor,
                     ...
                     *(int8_t *) alphaPtr, (int8_t *) aPtr, lda,
                     (float *) bPtr, ldb, *(float *) betaPtr,
                     (float *) cPtr, ldc);
    } else if (aType == DATA_TYPE_INT8 && bType == DATA_TYPE_FLOAT64) {
        ...
        tblas_slgemm(TblasRowMajor,
                     ...
                     *(int16_t *) alphaPtr, (int16_t *) aPtr, lda,
                     (int64_t *) bPtr, ldb, *(int64_t *) betaPtr,
                     (int64_t *) cPtr, ldc);
    } else if (aType == DATA_TYPE_INT16 && bType == DATA_TYPE_FLOAT32) {
        tblas_sfgemm(TblasRowMajor,
                     ...
                     *(int16_t *) alphaPtr, (int16_t *) aPtr, lda,
                     (float *) bPtr, ldb, *(float *) betaPtr,
                     (float *) cPtr, ldc);
    } else if (aType == DATA_TYPE_INT16 && bType == DATA_TYPE_FLOAT64) {
        ...
        tblas_ilgemm(TblasRowMajor,
                     ...
                     *(int32_t *) alphaPtr, (int32_t *) aPtr, lda,
                     (int64_t *) bPtr, ldb, *(int64_t *) betaPtr,
                     (int64_t *) cPtr, ldc);
    } else if (aType == DATA_TYPE_INT32 && bType == DATA_TYPE_FLOAT32) {
        tblas_ifgemm(TblasRowMajor,
                     ...
                     *(int32_t *) alphaPtr, (int32_t *) aPtr, lda,
                     (float *) bPtr, ldb, *(float *) betaPtr,
                     (float *) cPtr, ldc);
    } else if (aType == DATA_TYPE_INT32 && bType == DATA_TYPE_FLOAT64) {
        ...
        tblas_llgemm(TblasRowMajor,
                     ...
                     *(int64_t *) alphaPtr, (int64_t *) aPtr, lda,
                     (int64_t *) bPtr, ldb, *(int64_t *) betaPtr,
                     (int64_t *) cPtr, ldc);
    } else if (aType == DATA_TYPE_INT64 && bType == DATA_TYPE_FLOAT32) {
        tblas_lfgemm(TblasRowMajor,
                     ...
                     *(int64_t *) alphaPtr, (int64_t *) aPtr, lda,
                     (float *) bPtr, ldb, *(float *) betaPtr,
                     (float *) cPtr, ldc);
    } else if (aType == DATA_TYPE_INT64 && bType == DATA_TYPE_FLOAT64) {
        tblas_ldgemm(TblasRowMajor,
                     ...
                     *(int64_t *) alphaPtr, (int64_t *) aPtr, lda,
                     (double *) bPtr, ldb, *(double *) betaPtr,
                     (double *) cPtr, ldc);
    } else if (aType == DATA_TYPE_FLOAT32 && bType == DATA_TYPE_INT8) {
        tblas_fbgemm(TblasRowMajor,
                     ...
                     *(float *) alphaPtr, (float *) aPtr, lda,
                     (int8_t *) bPtr, ldb, *(int8_t *) betaPtr,
                     (float *) cPtr, ldc);
    } else if (aType == DATA_TYPE_FLOAT32 && bType == DATA_TYPE_INT16) {
        tblas_fsgemm(TblasRowMajor,
                     ...
                     *(float *) alphaPtr, (float *) aPtr, lda,
                     (int16_t *) bPtr, ldb, *(int16_t *) betaPtr,
                     (float *) cPtr, ldc);
    } else if (aType == DATA_TYPE_FLOAT32 && bType == DATA_TYPE_INT32) {
        tblas_figemm(TblasRowMajor,
                     transa == OP_TRANSPOSE ? TblasTrans : TblasNoTrans,
                        ...
                        *(float *) alphaPtr, (float *) aPtr, lda,
                        (int32_t *) bPtr, ldb, *(int32_t *) betaPtr,
                        (float *) cPtr, ldc);
    } else if (aType == DATA_TYPE_FLOAT32 && bType == DATA_TYPE_INT64) {
        tblas_flgemm(TblasRowMajor,
                     ...
                     *(float *) alphaPtr, (float *) aPtr, lda,
                     (int64_t *) bPtr, ldb, *(int64_t *) betaPtr,
                     (float *) cPtr, ldc);
    } else if (aType == DATA_TYPE_FLOAT32 && bType == DATA_TYPE_FLOAT32) {
        tblas_sgemm(TblasRowMajor,
                    transa == OP_TRANSPOSE ? TblasTrans : TblasNoTrans,
                    transb == OP_TRANSPOSE ? TblasTrans : TblasNoTrans,
                    m, n, k,
                    *(float *) alphaPtr, (float *) aPtr, lda,
                    (float *) bPtr, ldb, *(float *) betaPtr,
                    (float *) cPtr, ldc);
    } else if (aType == DATA_TYPE_FLOAT32 && bType == DATA_TYPE_FLOAT64) {
        tblas_fdgemm(TblasRowMajor,
                    ...
                    *(float *) alphaPtr, (float *) aPtr, lda,
                    (double *) bPtr, ldb, *(double *) betaPtr,
                    (double *) cPtr, ldc);
    } else if (aType == DATA_TYPE_FLOAT64 && bType == DATA_TYPE_INT8) {
        tblas_dbgemm(TblasRowMajor,
                     ...
                     *(double *) alphaPtr, (double *) aPtr, lda,
                     (int8_t *) bPtr, ldb, *(int8_t *) betaPtr,
                     (double *) cPtr, ldc);
    } else if (aType == DATA_TYPE_FLOAT64 && bType == DATA_TYPE_INT16) {
        tblas_dsgemm(TblasRowMajor,
                     ...
                     transb == OP_TRANSPOSE ? TblasTrans : TblasNoTrans,
                        ...
                        *(double *) alphaPtr, (double *) aPtr, lda,
                        (int16_t *) bPtr, ldb, *(int16_t *) betaPtr,
                        (double *) cPtr, ldc);
    } else if (aType == DATA_TYPE_FLOAT64 && bType == DATA_TYPE_INT32) {
        tblas_digemm(TblasRowMajor,
                     ...
                     *(double *) alphaPtr, (double *) aPtr, lda,
                     (int32_t *) bPtr, ldb, *(int32_t *) betaPtr,
                     (double *) cPtr, ldc);
    } else if (aType == DATA_TYPE_FLOAT64 && bType == DATA_TYPE_INT64) {
        tblas_dlgemm(TblasRowMajor,
                     ...
                     *(double *) alphaPtr, (double *) aPtr, lda,
                     (int64_t *) bPtr, ldb, *(int64_t *) betaPtr,
                     (double *) cPtr, ldc);
    } else if (aType == DATA_TYPE_FLOAT64 && bType == DATA_TYPE_FLOAT32) {
        tblas_dfgemm(TblasRowMajor,
                     ...
                     *(double *) alphaPtr, (double *) aPtr, lda,
                     (float *) bPtr, ldb, *(float *) betaPtr,
                     (double *) cPtr, ldc);
    } else if (aType == DATA_TYPE_FLOAT64 && bType == DATA_TYPE_FLOAT64) {
        tblas_dgemm(TblasRowMajor,
                    transa == OP_TRANSPOSE ? TblasTrans : TblasNoTrans,
                    transb == OP_TRANSPOSE ? TblasTrans : TblasNoTrans,
                    m, n, k,
