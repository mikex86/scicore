...
void tblas_sbgemm(TblasOrder order, TblasTranspose transa, TblasTranspose transb,
                  int m, int n, int k,
                  int16_t alpha, const int16_t *a, int lda,
                  const int8_t *b, int ldb, int8_t beta,
                  int16_t *c, int ldc);
...
void tblas_ibgemm(TblasOrder order, TblasTranspose transa, TblasTranspose transb,
                  int m, int n, int k,
                  int32_t alpha, const int32_t *a, int lda,
                  const int8_t *b, int ldb, int8_t beta,
                  int32_t *c, int ldc);
...
void tblas_lbgemm(TblasOrder order, TblasTranspose transa, TblasTranspose transb,
                  int m, int n, int k,
                  int64_t alpha, const int64_t *a, int lda,
                  const int8_t *b, int ldb, int8_t beta,
                  int64_t *c, int ldc);
