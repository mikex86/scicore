...
/// Multiply tensor by scalar (inplace, src=dst=A)
...
/// Scalar scale of a tensor (not in-place, dst = C)
...
/// Multiply tensor by tensor of same length (element-wise, no broadcasting, in-place, src=dst=A)
...
/// Multiply tensor by tensor of same length (element-wise, no broadcasting, not in-place, dst = C)
...
/// Multiply tensor by tensor (element-wise, with broadcasting, in-place, src=dst=A)
...
void tblas_tensor_lfmul_broadcast(uint64_t *A, float *B, float *C, size_t n, size_t r);
void tblas_tensor_ldmul_broadcast(uint64_t *A, double *B, double *C, size_t n, size_t r);
void tblas_tensor_fbmul_broadcast(float *A, uint8_t *B, float *C, size_t n, size_t r);
void tblas_tensor_fsmul_broadcast(float *A, uint16_t *B, float *C, size_t n, size_t r);
void tblas_tensor_fimul_broadcast(float *A, uint32_t *B, float *C, size_t n, size_t r);
void tblas_tensor_flmul_broadcast(float *A, uint64_t *B, float *C, size_t n, size_t r);
void tblas_tensor_ffmul_broadcast(float *A, float *B, float *C, size_t n, size_t r);
void tblas_tensor_fdmul_broadcast(float *A, double *B, double *C, size_t n, size_t r);
void tblas_tensor_dbmul_broadcast(double *A, uint8_t *B, double *C, size_t n, size_t r);
void tblas_tensor_dsmul_broadcast(double *A, uint16_t *B, double *C, size_t n, size_t r);
void tblas_tensor_dimul_broadcast(double *A, uint32_t *B, double *C, size_t n, size_t r);
void tblas_tensor_dlmul_broadcast(double *A, uint64_t *B, double *C, size_t n, size_t r);
void tblas_tensor_dfmul_broadcast(double *A, float *B, double *C, size_t n, size_t r);
void tblas_tensor_ddmul_broadcast(double *A, double *B, double *C, size_t n, size_t r);
