...
class PlusJNITest {
    ...
    @NotNull
    public Stream<Arguments> getPlusData(int nElementsA, int nElementsB) {
    ...
    @NotNull
    public Stream<Arguments> getPlusData_sameLengthNoBroadcast() {
        return getPlusData(100, 100);
    }

    @NotNull
    public Stream<Arguments> getPlusData_differentLengthAGreaterBWithBroadcast() {
        return getPlusData(100, 50);
    }

    @NotNull
    public Stream<Arguments> getPlusData_differentLengthBGreaterAWithBroadcast() {
        return getPlusData(50, 100);
    }

    @NotNull
    public Stream<Arguments> getPlusData_differentLengthBIsScalar() {
        return getPlusData(100, 1);
    }

    @NotNull
    public Stream<Arguments> getPlusData_differentLengthAIsScalar() {
        return getPlusData(1, 100);
    }

    @ParameterizedTest
    @MethodSource("getPlusData_sameLengthNoBroadcast")
    void plus_sameLengthNoBroadcast_success(DirectMemoryHandle a,
                                            DataType aDataType,
                                            long nElementsA,
                                            ...
                                            DataType cDataType) {
        PlusJNI.plus(a.getNativePtr(), aDataType, nElementsA, b.getNativePtr(), bDataType, nElementsB, c.getNativePtr(), nElementsC, cDataType);
    ...
    @ParameterizedTest
    @MethodSource("getPlusData_differentLengthAGreaterBWithBroadcast")
    void plus_differentLengthAGreaterB_success(DirectMemoryHandle a,
                                               DataType aDataType,
                                               long nElementsA,
                                               DirectMemoryHandle b,
                                               DataType bDataType,
    ...
    @ParameterizedTest
    @MethodSource("getPlusData_differentLengthBGreaterAWithBroadcast")
    void plus_differentLengthBGreaterA_success(DirectMemoryHandle a,
                                               DataType aDataType,
                                               long nElementsA,
                                               DirectMemoryHandle b,
                                               DataType bDataType,
    ...
    @ParameterizedTest
    @MethodSource("getPlusData_differentLengthBIsScalar")
    void plus_differentLengthBIsScalar_success(DirectMemoryHandle a,
                                               DataType aDataType,
                                               long nElementsA,
                                               DirectMemoryHandle b,
                                               DataType bDataType,
    ...
    @ParameterizedTest
    @MethodSource("getPlusData_differentLengthAIsScalar")
    void plus_differentLengthAIsScalar_success(DirectMemoryHandle a,
                                               DataType aDataType,
                                               long nElementsA,
                                               DirectMemoryHandle b,
                                               DataType bDataType,
