...
//
//                    if (Float.isNaN(loss.elementAsFloat()) || Float.isNaN(diffWeightsFc1.elementAsFloat()) || Float.isNaN(diffBiasFc1.elementAsFloat()) || Float.isNaN(diffWeightsFc2.elementAsFloat()) || Float.isNaN(diffBiasFc2.elementAsFloat())) {
